...
class ValidationTest(unittest.TestCase):
    ...
    def test_validate_bad_files(self):
        ...
        assert (
            "Checking if " + bad_files[0] + " is a valid MRC2014 file..."
            in print_output
        )
        assert (
            "Checking if " + bad_files[1] + " is a valid MRC2014 file..."
            in print_output
        )
        assert (
            "Checking if " + bad_files[2] + " is a valid MRC2014 file..."
            in print_output
        )
        assert (
            "Checking if " + bad_files[3] + " is a valid MRC2014 file..."
            in print_output
        )
